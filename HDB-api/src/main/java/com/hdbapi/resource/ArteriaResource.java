...
import com.hdbapi.service.ArteriaService;
...
public class ArteriaResource {
	...
	@Autowired
	private ArteriaService arteriaService;
	...
	@PutMapping("/{codarteria}")
	public ResponseEntity<Arteria> atualizarArteria(@PathVariable Long codarteria, @Valid @RequestBody Arteria arteria){
		
		Arteria arteriaAtualizada = arteriaService.atualizarArteria(codarteria, arteria);
		return ResponseEntity.ok(arteriaAtualizada);
